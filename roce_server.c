...
static int setup_client_resources() {
	...
	//Request for notification on CQ
...
static int send_server_metadata_to_client() {
	...
	//Add information to metadata buffer
...
int main(int argc, char **argv) 
{
	...
	//Call all server-side functions
